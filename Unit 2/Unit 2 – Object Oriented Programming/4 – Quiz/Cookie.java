...
/**
 * Name: Harry Liu
 * Description: This is a class for Cookie, contains the required attributes, constructors, and methods
 * Date: Mar 1, 2022
 */
...
public class Cookie {
	...
	/**
	 * Name: Cookie
	 * Description: default constructor for Cookie, set name to empty, weight and calories to -1, and assume cookie is not packaged
	 */
	public Cookie () {
		name = "";
		weight = -1;
	...
	/**
	 * Name: eaten
	 * Description: cookie is eaten, weight and calories of the cookie decrease
	...
	public int eaten (double weight) {
		...
		return caloriesEaten;	//return the calories eaten
	}
	...
	public String toString() {
		return "Name: " + name + "\nWeight: " + weight + "\nCalories: " + calories + "\nPackaged or not: " + (isPackaged ? "Yes" : "No");
	}
}
